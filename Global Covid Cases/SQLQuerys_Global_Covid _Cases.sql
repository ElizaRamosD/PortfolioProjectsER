...
-- EDA for Covid Data
-- Data collected from Our World in Data (From: Feb, 2020 To: January 12,2022)

-- Lets take a lok at the data
...
-- Query 15: -tableau, Total Death Count by Continent(location), European Union is part of Europe
...
--Query 16: tableau PercentPopulationInfected 
SELECT
 location,
 population,
 MAX(total_cases) AS HighestInfectionCount,
